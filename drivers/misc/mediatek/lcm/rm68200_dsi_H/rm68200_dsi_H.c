...
static void lcd_power_en(unsigned char enabled)
{
  ...
  #ifdef BUILD_LK
  #else 
    pmic_config_interface(MT6350_PMIC_RG_VGP1_VOSEL_ADDR, 0x6, MT6350_PMIC_RG_VGP1_VOSEL_MASK, MT6350_PMIC_RG_VGP1_VOSEL_SHIFT);
    pmic_config_interface(MT6350_PMIC_RG_VGP1_EN_ADDR, 0x1, MT6350_PMIC_RG_VGP1_EN_MASK, MT6350_PMIC_RG_VGP1_EN_SHIFT);
    MDELAY(50);
  #endif
    }
    else
  ...
  #ifdef BUILD_LK
  #else
    pmic_config_interface(MT6350_PMIC_RG_VGP1_VOSEL_ADDR, 0, MT6350_PMIC_RG_VGP1_VOSEL_MASK, MT6350_PMIC_RG_VGP1_VOSEL_SHIFT);
      pmic_config_interface(MT6350_PMIC_RG_VGP1_EN_ADDR, 0, MT6350_PMIC_RG_VGP1_EN_MASK, MT6350_PMIC_RG_VGP1_EN_SHIFT);
    MDELAY(50);
  #endif
    }
}
